...
const CreateQuizPage = () => {
  ...
  return (
    <div className="flex justify-center min-h-[90vh] px-4 py-8 text-slate-900">
      <div className="w-full max-w-342">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-violet-300 hover:text-violet-600 cursor-pointer"
            >
              <Plus size={18} />
              Add question
            </button>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-violet-500 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
            >
              <Save size={18} />
